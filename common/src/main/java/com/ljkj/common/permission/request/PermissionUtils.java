...
import com.ljkj.common.permission.annotations.HasPermission;
import com.ljkj.common.permission.annotations.NoPermission;
...
public final class PermissionUtils {
        ...
        for (Method method : methods) {
            ...
            if (succeedMethod != null) {
                ...
                try {
                    ...
                    method.invoke(object, succeedPermissions);
        ...
        for (Method method : methods) {
            ...
            if (failMethod != null) {
                ...
                try {
                    ...
                    //调用时直接传一个String[]实例会报异常，需要再次用Object[]包装一下
                    method.invoke(object, failPermissions, quick);
    ...
    static boolean isCorrectObject(Object object) {
        return object instanceof Activity || object instanceof Fragment || object instanceof Fragment;
    }
