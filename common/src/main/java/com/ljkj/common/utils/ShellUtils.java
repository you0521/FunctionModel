...
public  class ShellUtils {
     ...
     * @return the task
     */
    public static ActivityUtils.Task<CommandResult> execCmdAsync(final String command,
                                                         final boolean isRooted,
                                                         final ActivityUtils.Callback<CommandResult> callback) {
     ...
     * @return the task
     */
    public static ActivityUtils.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                         final boolean isRooted,
                                                         final ActivityUtils.Callback<CommandResult> callback) {
     ...
     * @return the task
     */
    public static ActivityUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                         final boolean isRooted,
                                                         final ActivityUtils.Callback<CommandResult> callback) {
    ...
    public static ActivityUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                         final boolean isRooted,
                                                         final boolean isNeedResultMsg,
                                                         @NonNull final ActivityUtils.Callback<CommandResult> callback) {
        return ActivityUtils.doAsync(new ActivityUtils.Task<CommandResult>(callback) {
            @Override
