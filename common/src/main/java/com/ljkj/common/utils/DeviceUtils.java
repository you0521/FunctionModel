...
public class DeviceUtils {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(
                ActivityUtils.getApp().getContentResolver(),
    ...
    private static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) ActivityUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) ActivityUtils.getApp()
    ...
    public static boolean isTablet() {
        return (ActivityUtils.getApp().getResources().getConfiguration().screenLayout
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) ActivityUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
        ...
        boolean checkDial = intent.resolveActivity(ActivityUtils.getApp().getPackageManager()) == null;
    ...
    public static String getUniqueDeviceId(String prefix) {
        if (udid == null) {
            synchronized (DeviceUtils.class) {
                if (udid == null) {
                    final String id = (String) PreferencesUtils.get(KEY_UDID, null);
                    if (id != null) {
                        udid = id;
                        return udid;
                    }
    ...
    public static boolean isSameDevice(final String uniqueDeviceId) {
        ...
        final String cachedId = (String) PreferencesUtils.get(KEY_UDID, null);
    ...
    private static String saveUdid(String prefix, String id) {
        ...
        PreferencesUtils.putString(ActivityUtils.getApp(), KEY_UDID, udid);
        return udid;
    }
