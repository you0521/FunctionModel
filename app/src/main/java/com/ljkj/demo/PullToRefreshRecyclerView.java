...
public class PullToRefreshRecyclerView extends LinearLayout {
    ...
    private ImageView emptyViewIconIV;
    private TextView emptyViewMsgTV;
    ...
    private void initView(Context context) {
        mContext = context;
        View view = LayoutInflater.from(context).inflate(R.layout.common_pull_loadmore_layout, null);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipeRefreshLayout);
        emptyViewLayout = (LinearLayout) view.findViewById(R.id.layout_empty_view);
        emptyViewIconIV = (ImageView) view.findViewById(R.id.iv_empty_icon);
        emptyViewMsgTV = (TextView) view.findViewById(R.id.tv_empty_msg);
     ...
     * @param msg
     */
    public void setEmptyView(int iconRes, String msg) {
        emptyViewIconIV.setImageResource(iconRes);
        emptyViewMsgTV.setText(msg);
    }
